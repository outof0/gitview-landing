...
3. Preserve official casing: **GitView**.
...
GitView also defines:
```text
graph.*        branch/commit visualization only
```
Never bind `graph.green` directly to `semantic.success`.
